...
export const Map = ({ 
  ...
  const aspect = width / height;
    ...
    let arr5to30 = [89, 92, 96, 129, 131, 135, 137, 145, 148, 151, 154, 231, 234, 247, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 261, 267, 271,219,220,212,222,223,224,225,226,227,228]
