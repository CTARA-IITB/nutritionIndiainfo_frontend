...
export async function setVisulaizationData(
  ...
  const url_1 = await fetch(
    `http://localhost:5000/api/v1/url_1u?area=${area}&indicator=${indicator}`
  );
  ...
  const url_2 = await fetch(
    `http://localhost:5000/api/v1/url_2u?area=1&indicator=${indicator}&timeperiod=${timeperiod}`
  );
  ...
  if (level === 1) {
    const solr_url_3 = await fetch(
      `http://localhost:5000/api/v1/url_3u?indicator=${indicator}&timeperiod=${timeperiod}`
    );
    ...
    if (levelThree) {
      solr_url_4 = await fetch(
        `http://localhost:5000/api/v1/url_4b_u?parentArea=${parentArea}&indicator=${indicator}&timeperiod=${timeperiod}`
      );
      // solr_url_4 = await fetch(
      ...
      solr_url_4 = await fetch(
        `http://localhost:5000/api/v1/url_4c_u?area=${area}&indicator=${indicator}&timeperiod=${timeperiod}`
      );
      // solr_url_4 = await fetch(
  ...
  const solr_switchurl = await fetch(
    `http://localhost:5000/api/v1/url_5u?indicator=${indicator}&timeperiod=${timeperiod}`
  );
...
export async function populateDropdowns(
  ...
  const solr_url_6 = await fetch(
    `http://localhost:5000/api/v1/url_6u?selCategory=${selCategory}&selLifecycle=${selLifeycle}`
  );
  // const solr_url_6 = await fetch(
  ...
  const solr_url_8 = await fetch(`http://localhost:5000/api/v1/url_8u?indiVal=${indiVal}`)
  ...
  let solr_url;
  // URL_9
  solr_url = await fetch(`http://localhost:5000/api/v1/url_9u?selLifeycle=${selLifeycle}&selCategory=${selCategory}&indiVal=${indiVal}&selArea=${selArea}`)
