...
export const Map = ({ 
  ...
  const aspect = width / height;
    ...
    let arr20to80 = [31,11,28,37,51,66,42,43,84,23,25,32,99,100,70,76,77,78,75,4,5,6,7,14,15,34,57,24,74,85,86,277,286,293,298,304,309,329,317,326,320,333,334,335,285,352,353,354]
