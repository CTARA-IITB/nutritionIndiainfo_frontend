...
export const Dropdown = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const newDistrictTopology = require('../../data/boundaries/nfhs5/district_nfhs5_14_dec_2021.json')
      ...
      const newDistrictObject = newDistrictTopology.objects["district_nfhs5_14_dec_2021"];
