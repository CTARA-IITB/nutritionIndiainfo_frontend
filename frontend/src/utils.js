...
export async function setVisulaizationData(
  ...
  const url_1 = await fetch(
    `http://localhost:5000/url_1?area=${area}&indicator=${indicator}`
  );
  ...
  const url_2 = await fetch(
    `http://localhost:5000/url_2?area=1&indicator=${indicator}&timeperiod=${timeperiod}`
  );
  ...
  if (level === 1) {
    const solr_url_3 = await fetch(
      `http://localhost:5000/url_3?indicator=${indicator}&timeperiod=${timeperiod}`
    );
    ...
    if (levelThree) {
      solr_url_4 = await fetch(
        `http://localhost:5000/url_4a?parentArea=${parentArea}&indicator=${indicator}&timeperiod=${timeperiod}`
      );
      // solr_url_4 = await fetch(
      ...
      solr_url_4 = await fetch(
        `http://localhost:5000/url_4b?area=${area}&indicator=${indicator}&timeperiod=${timeperiod}`
      );
      // solr_url_4 = await fetch(
  ...
  const solr_switchurl = await fetch(
    `http://localhost:5000/url_5?indicator=${indicator}&timeperiod=${timeperiod}`
  );
...
export async function populateDropdowns(
  ...
  const solr_url_6 = await fetch(
    `http://localhost:5000/url_6?selCategory=${selCategory}&selLifecycle=${selLifeycle}`
  );
  // const solr_url_6 = await fetch(
  ...
  const solr_url_8 = await fetch(`http://localhost:5000/url_8?indiVal=${indiVal}`)
  ...
  let solr_url;
  // URL_9
  solr_url = await fetch(`http://localhost:5000/url_9?selLifeycle=${selLifeycle}&selCategory=${selCategory}&indiVal=${indiVal}&selArea=${selArea}`)
